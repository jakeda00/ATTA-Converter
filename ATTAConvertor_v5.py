...
def create_batch_win():
    ...
    global batchopen, batchwin, rad1, rad2, b_conv_batch, outputdriver, inputdriver
    ...
    if batchopen == 0:
        ...
        leftsep_frame = Frame(batchwin, bg='saddle brown', width=6, height=524)
        ...
        rightsep_frame = Frame(batchwin, bg='saddle brown', width=6, height=524)
        ...
        folder_frame.grid( column=1, row=2)
        ...
        Button(folder_frame, text="Choose \na directory", height=5, width=12, command=choosedir, pady=10, padx=10, bg="PeachPuff3").grid(row=1, column=0)
        Label(folder_frame, text="Folder path:  ", font="Helvetica 10 bold",pady=10,padx=10).grid(row=1, column=1)
        folder_l = Message(folder_frame, text="dsbfkadsbfksbkfbadsfdfgdfgdgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdfgdlfasdbfjdsvafl", font="Helvetica 9", padx=10, width=270, pady=5)
        folder_l.grid(row=1, column=2, sticky=W)
        ...
        Label(batch_frame, text="Original file type", font="Helvetica 10", bg="PeachPuff3").grid(row=1, column=0)
        Label(batch_frame, text="->", font="Helvetica 20 bold", bg="PeachPuff3").grid(row=1, column=1, rowspan=10)
        Label(batch_frame, text="New file type", font="Helvetica 10", bg="PeachPuff3").grid(row=1, column=2)
        ...
        b_conv_batch = Button(batch_frame, text="Convert multiple files", command=convert_batch, state=DISABLED, pady=10,padx=10,bg="saddle brown")
        b_conv_batch.grid(row=11, columnspan=3)
        Label(batch_frame, text="", font="Helvetica 10", bg="PeachPuff3").grid(row=12, column=0)


def choosedir():
    global inputdir,batchwin,rad1,rad2, b_conv_batch
    if (inputdir == ""):
...
def convert_batch():
    ...
    global outputdriver, inputdriver, inputdir, batchwin, inputname
...
global inputname, lfilename, bopenfile, aboutopen, abouttext, workwin, batchopen,inputdir, rad1, rad2, b_conv_batch, outputdriver, inputdriver
...
batch_frame = Frame(mainwin, width=400, height=150)
...
batch_frame.grid(row=1, column=1, sticky='nw', pady=13, padx=0)
...
Label(batch_frame, text="", font="Helvetica 1").grid(row=0, column=0)

Label(batch_frame, text="File name:  ", font="Helvetica 10 bold").grid(row=1, column=0, sticky=W)
lfilename = Message(batch_frame, text="", font="Helvetica 10 bold", padx=10, width=290, pady=5)
lfilename.grid(row=1, column=1, sticky=W)

Label(batch_frame, text="", font="Helvetica 1").grid(row=2, column=0)

Label(batch_frame, text="Format:  ", font="Helvetica 10 bold").grid(row=3, column=0, sticky=E)
lfileformat = Label(batch_frame, text="", font="Helvetica 10", padx=10, pady=5)
lfileformat.grid(row=3, column=1, sticky=W)

Label(batch_frame, text="", font="Helvetica 1").grid(row=4, column=0)

Label(batch_frame, text="Path:  ", font="Helvetica 10 bold").grid(row=5, column=0, sticky=E)
lpath = Message(batch_frame, text="", font="Helvetica 8", padx=10, width=290, pady=5)
lpath.grid(row=5, column=1, sticky=W)

Label(batch_frame, text="", font="Helvetica 1").grid(row=6, column=0)
