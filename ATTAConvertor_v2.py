...
def endofconv():
    global workwin
    workwin.destroy()
    if tkMessageBox.askokcancel(u"Convert another file?", "Are you want to convert some another file?"):
        new()
...
def about():
    ...
    if aboutopen == 0:
        ...
        sep2_frame.grid(row=2)
        Label(about_frame, text="Author:").grid(row=0, column=0)
