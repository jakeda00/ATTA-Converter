...
def formats():
    ...
    def form_asci():
        ...
        l_limit.config(text="rst asd asd as dasdasdas sad asdas d as")
    ...
    if formatopen == 0:
        ...
        formatwin.title("Supported Formats - ATTA Convertor")
        ...
        l_limit = Message(about_frame, text="ani nevim jeste", font='Helvetica 8', bg='PeachPuff3',width=300)
